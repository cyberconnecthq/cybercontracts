...
library LibDeploy {
    ...
    function deploy(address deployer, uint256 nonce) internal {
        ...
        _requiresContractAddress(deployer, nonce, address(rolesAuthority));
        ...
        _requiresContractAddress(deployer, nonce + 3, address(profileProxy));
