...
import { LimitedPaidCollectEssenceMw } from "../../../../src/middlewares/essence/LimitedPaidCollectEssenceMw.sol";
...
contract LimitedPaidCollectEssenceMwTest is
    TestIntegrationBase,
    ICyberEngineEvents,
    IProfileNFTEvents,
    ITreasuryEvents
{
    ...
    string constant BOBBY_ESSENCE_NAME = "Addicted Essence";
    string constant BOBBY_ESSENCE_LABEL = "AE";
    ...
    ERC20 token;
    LimitedPaidCollectEssenceMw limitedPaidCollectEssenceMw;
    ...
    function setUp() public {
        ...
        limitedPaidCollectEssenceMw = new LimitedPaidCollectEssenceMw(
            addrs.cyberTreasury
        );
        vm.label(
            address(limitedPaidCollectEssenceMw),
            "limitedPaidCollectEssenceMw"
        );
        ...
        // dave registers for their profile
        daveProfileId = TestLibFixture.registerProfile(
            vm,
            link3Profile,
            profileMw,
            daveHandle,
    ...
    function testCollectFromDifferentCollectorsUnderLimit() public {
        ...
        emit AllowEssenceMw(address(limitedPaidCollectEssenceMw), false, true);
        engine.allowEssenceMw(address(limitedPaidCollectEssenceMw), true);
        ...
        vm.startPrank(lila);
        token.approve(address(limitedPaidCollectEssenceMw), 5000);
